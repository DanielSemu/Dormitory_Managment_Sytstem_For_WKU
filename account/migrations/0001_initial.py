    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Disability', models.CharField(choices=[('Disable', 'Disable'), ('Not_Disable', 'Not_Disable')], max_length=100)),
                ('Campus', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='account.blocktype')),
            ],
        ),
        migrations.CreateModel(
            name='UserAccount',
